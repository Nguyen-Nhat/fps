...
func TestGetFileProcessHistory_Input_filter_by_tenant_id__Should_return_code_200(t *testing.T) {
	detail := jiraTestDetailsForSample
	detail.Name = "[GetFileProcessHistory] Return code = 200 when filter by tenant"
	defer detail.Setup(t)()
	...
	goldie.New(t).AssertJson(t, "get_file_process_history/filter_by_tenant_id", respData)
}

func TestGetFileProcessHistory_Input_filter_by_merchant_id__Should_return_code_200(t *testing.T) {
	detail := jiraTestDetailsForSample
	detail.Name = "[GetFileProcessHistory] Return code = 200 when filter by merchant id"
	defer detail.Setup(t)()
