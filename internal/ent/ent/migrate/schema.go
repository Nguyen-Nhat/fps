...
var (
	...
	ConfigMappingColumns = []*schema.Column{
		...
		{Name: "max_file_size", Type: field.TypeInt32, Default: 5},
		{Name: "tenant_id", Type: field.TypeString, Nullable: true},
		{Name: "using_merchant_attr_name", Type: field.TypeBool, Default: false},
		{Name: "merchant_attribute_name", Type: field.TypeString, Nullable: true},
		{Name: "ui_config", Type: field.TypeString, Nullable: true, Size: 2147483647},
	...
	FpsClientColumns = []*schema.Column{
		...
		{Name: "sample_file_url", Type: field.TypeString, Default: ""},
		{Name: "import_file_template_url", Type: field.TypeString, Nullable: true},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "created_by", Type: field.TypeString},
		{Name: "updated_at", Type: field.TypeTime},
	}
